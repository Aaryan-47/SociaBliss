...
const setNotificationToUnread =async(userId)=>{
     try{
        ...
        if(user.unreadNotif===false)
        {
            user.unreadNotif=true;
            await user.save();
        }
...
module.exports={newLikeNotification,removeLikeNotification,newCommentNotification,removeCommentNotification,newFollowerNotification,removeFollowerNotification}